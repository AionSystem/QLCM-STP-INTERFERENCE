# QLCM · STP Interference Experiment
...
Use the [observation issue template](.github/ISSUE_TEMPLATE/observation.md) to log open findings, anomalies, or questions that arise during an experiment run.
...
If you reference this experiment in your own work, please use the citation metadata in [`CITATION.cff`](./CITATION.cff). A Zenodo DOI will be assigned on first stable release.
